package mil.nga.xid.vandl.webapp.util;
...
public class HttpsRequestFactory extends HttpComponentsClientHttpRequestFactory {
    ...
    public HttpsRequestFactory(String path, String pass) throws Exception{
        ...
        setHttpClient(HttpClientBuilder.create().setDefaultCredentialsProvider(bc).setSslcontext(buildSSLContext(path,pass)).build());
    }
